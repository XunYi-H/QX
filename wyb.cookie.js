...
[rewrite_local]
# 获取无忧行Cookie
https?:\/\/app.*\.jegotrip\.com\.cn\/.*getUser url script-response-body https://raw.githubusercontent.com/XunYi-H/QX/master/wyb.js
https?:\/\/task\.jegotrip\.com\.cn\:8080\/app\/tasks\?userid url script-response-body https://raw.githubusercontent.com/XunYi-H/QX/master/wyb.cookie.js
https:\/\/.+\.easemob\.com(\:443)?\/\d+\/jegotrip\/users\/ url script-response-body https://raw.githubusercontent.com/XunYi-H/QX/master/wyb.cookie.js

**/

const $ = new Env('无忧行');
$.ACCOUNT_ID_KEY = 'wyb_accountId';
$.USER_ID_KEY = 'wyb_userId';
$.MOBILE_KEY = 'wyb_mobile';
$.TOKEN_KEY = 'wyb_token';
$.TASK_ID_KEY = 'wyb_taskId';
