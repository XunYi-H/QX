...
*/
const $ = new Env('无忧行');
const accountId = $.getData('wyb_accountId');
const userId = $.getData('wyb_userId');
const mobile = $.getData('wyb_mobile');
const token = $.getData('wyb_token');
const taskId =
  $.getData('wyb_taskId') || '2c909969630101e7016325c827520000';
